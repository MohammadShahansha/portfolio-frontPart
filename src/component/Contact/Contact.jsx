...
const Contact = () => {
  ...
  return (
    <div className="py-20" id="contact">
      ...
      <div className="py-3 md:flex items-center px-2 md:ml-64 gap-40">
        ...
        <div className="text-[--text-color] mt-10">
          <div className="infos">
            ...
            <div className="mb-5">
              <h2 className="font-semibold text-lg mt-2 info">
                WhatsApp & Telegram
              </h2>
            ...
            <div className="socials mx-auto md:ms-0">
              ...
              <a href="https://www.linkedin.com/in/md-shahansha-mia-aa14aa284/">
